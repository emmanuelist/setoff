  ...
  return (
    <main className="px-[var(--gutter)] pt-[var(--seam)]">
      <section className="plate grid min-h-[50svh] content-center justify-items-start gap-5 p-6 sm:p-10">
        ...
        <h1 className="text-[clamp(26px,3vw,36px)] font-bold tracking-[-0.015em]">Arc didn&apos;t answer this time.</h1>
        <p className="max-w-[60ch] text-[15px] leading-[1.55] text-graphite">
