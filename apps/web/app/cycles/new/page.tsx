      ...
      <div className="bento">
        <section className="plate col-span-12 grid content-start gap-7 p-6 sm:p-9 lg:col-span-7">
          <div className="grid gap-4">
            <h1 className="max-w-[18ch] text-[clamp(32px,3.8vw,50px)] leading-[1.02] font-bold tracking-[-0.02em] [font-variation-settings:'wdth'_108]">Set the cutoff, then let the debts come in.</h1>
